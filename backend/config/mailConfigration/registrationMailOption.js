const registrationMailOptions = (
  ...
  const mailOptions = {
    ...
    text: `${greetMessage}`, // Plain text body
    html: `
    <html
       lang="en"
       >
                                           ...
                                           <table
                                              ...
                                              <tr>
                                                 <td
                                                    ...
                                                    <div align="center" class="alignment">
                                                       <!--[if mso]>
                                                       <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:62px;width:203px;v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#e44fa4">
                                                          <w:anchorlock/>
    ...
    `, // Use message parameter here
    };

  return mailOptions;
};

module.exports = registrationMailOptions;
