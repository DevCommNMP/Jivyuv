export default function tourGuide() {
    return (
        <>
            ...
            {/* <!-- Page Title --> */}
            <section class="page-title centred" style={{ backgroundImage: 'url(assets/images/background/page-title-4.jpg);' }}>
                            ...
                            <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="about.html">Merrie Lewis</a></h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                            <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="about.html">Parks Missie</a></h3>
                                        <span class="designation">Tour Guide</span>
                                        <ul class="social-links clearfix">
                                            <li><a href="about.html"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="about.html"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                            <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="about.html">Mariana Buenos</a></h3>
                                        <span class="designation">Tour Guide</span>
                                        <ul class="social-links clearfix">
                                            <li><a href="about.html"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="about.html"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                            <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="about.html">Stephen Fowler</a></h3>
                                        <span class="designation">Tour Guide</span>
                                        <ul class="social-links clearfix">
                                            <li><a href="about.html"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="about.html"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                            <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="about.html">Daisy Phillips</a></h3>
                                        <span class="designation">Tour Guide</span>
                                        <ul class="social-links clearfix">
                                            <li><a href="about.html"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="about.html"><i class="fab fa-twitter"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                            <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="about.html">Gregory Bowman</a></h3>
                                        <span class="designation">Tour Guide</span>
                                        <ul class="social-links clearfix">
                                            <li><a href="about.html"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="about.html"><i class="fab fa-twitter"></i></a></li>
            ...
            {/* <!-- video-section --> */}
            <section class="video-section centred" style={{ backgroundImage: 'url(assets/images/background/video-1.jpg);' }}>
                <div class="auto-container">
                    <div class="inner-box">
                    ...
                    <div class="three-item-carousel owl-carousel owl-theme owl-nav-none">
                        <div class="testimonial-block-one">
                            <div class="inner-box">
                                ...
                                <div class="text">
                                    <div class="icon" style={{ backgroundImage: 'url(assets/images/icons/quote-1.png);' }}></div>
