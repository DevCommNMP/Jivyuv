                    ...
                    <div className="row clearfix">
                                        ...
                                        <div className="place-block-one">
                                            <div className="inner-box">
                                                <figure className="image-box">
                                                    <img src={`/assets/images/resource/${place.image}`} alt={place.title} />
                                                </figure>
                                                <div className="text">
                                                    <h3>
                        ...
                        <div className="col-lg-4 col-md-12 col-sm-12 place-block">
                            <div className="place-block-one">
                                <div className="inner-box">
                                    <figure className="image-box">
                                        <img src="/assets/images/resource/place-13.jpg" alt="Norway Lake" />
                                    </figure>
                                    <div className="text">
                                        <h3>
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 place-block">
                            <div className="place-block-one">
                                <div className="inner-box">
                                    <figure className="image-box">
                                        <img src="/assets/images/resource/place-14.jpg" alt="Netherland" />
                                    </figure>
                                    <div className="text">
                                        <h3>
                        ...
                        <div className="col-lg-4 col-md-12 col-sm-12 place-block">
                            <div className="place-block-one">
                                <div className="inner-box">
                                    <figure className="image-box">
                                        <img src="/assets/images/resource/place-10.jpg" alt="Costa Rica" />
                                    </figure>
                                    <div className="text">
                                        <h3>
