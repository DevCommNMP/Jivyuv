...
export async function fetchCategoriesAndCompanyProfile(setIsLoading, setCategories, setCompanyData,setPackageData) {
    setIsLoading(true);

    try {
        // Fetch categories and company profile data concurrently
        const [categoriesResponse, companyProfileResponse,packageData] = await Promise.all([
        ...
        setPackageData(packageData.data.reverse());
